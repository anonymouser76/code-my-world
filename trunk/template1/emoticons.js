...
_str = _str.replace(/:cry/gi, "<img src='http://3.bp.blogspot.com/-AkDZzXbA5Cs/Uq3Vyiwnz_I/AAAAAAAAFYU/uy3ZWsJqZWg/s1600/cry.png' alt='' class='smiley'/>"); 
...
_str = _str.replace(/:d/gi, "<img src='http://4.bp.blogspot.com/-94bDjgoahf8/Uq3Vza5JYQI/AAAAAAAAFYs/JDMxgCX6KWc/s1600/devil.png' alt='' class='smiley'/>"); 
...
_str = _str.replace(/:n/gi, "<img src='http://4.bp.blogspot.com/-siOpRhzNSdc/Uq3V0prjmUI/AAAAAAAAFZA/AP1yhoZJZBQ/s1600/grin.png' alt='' class='smiley'/>"); 
...
_str = _str.replace(/:k/gi, "<img src='http://1.bp.blogspot.com/-G_fmylpuuJI/Uq3V1inMr5I/AAAAAAAAFZY/lytupJ2Z3cU/s1600/kiki.png' alt='' class='smiley'/>"); 
_str = _str.replace(/:s/gi, "<img src='http://3.bp.blogspot.com/-mFjqh71W5uk/Uq3V2Wb132I/AAAAAAAAFZg/emFgvNGAers/s1600/kiss.png' alt='' class='smiley'/>"); 
_str = _str.replace(/:p/gi, "<img src='http://4.bp.blogspot.com/-q5fwy86Ffd8/Uq3V2sEGk-I/AAAAAAAAFZ0/LNNCYys_TZ0/s1600/pacman.png' alt='' class='smiley'/>"); 
_str = _str.replace(/:t/gi, "<img src='http://3.bp.blogspot.com/-j44xFGDWpKc/Uq3V2_ZQgyI/AAAAAAAAFZw/DPwYe4HQHA4/s1600/tongue.png' alt='' class='smiley'/>"); 
_str = _str.replace(/:w/gi, "<img src='http://1.bp.blogspot.com/-iHr2Ky-aqkA/Uq3V3Z86OHI/AAAAAAAAFaE/DFaZSuQSln8/s1600/wink.png' alt='' class='smiley'/>")  
